...
// Sheet value -> this app's guest_categories.name. Both raw spellings the
// spreadsheet has used map to "Retreat" — the category originally seeded as
// "Resident" was renamed to "Retreat" on the live server.
